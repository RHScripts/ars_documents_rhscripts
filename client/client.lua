...
RegisterNUICallback("giveItem", function(data)
    lib.callback('ars_documents:getName', false, function(name)
        ...
        TriggerServerEvent("ars_documents:createDocument", metadata)
        SetNuiFocus(false, false)
    end)
end)
...
print("Full Item List:", json.encode(itemList, { indent = true }))

-- Get the full table of shared/weapons.lua
local weaponList = exports['qs-inventory']:GetWeaponList()
print("Full Weapon List:", json.encode(weaponList, { indent = true }))
